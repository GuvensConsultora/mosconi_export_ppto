                ...
                for lines in sale_order.order_line:
                    ...
                    for line in lines:
                        ...
                        if line.product_template_id.l10n_ar_ncm_code == "9999":
                            ...
                            sheet.write(row, 11, float(t.amount or 0.0))
                            sheet.write(row, 12, t.state or "")
                            sheet.write(row, 13, line.product_id.default_code or "")
                            sheet.write(row, 14, line.product_id.name or "")
                            row += 1
